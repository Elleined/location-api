pipeline {
    ...
    stages {
        stage("Clone Philippine Location API from Github") {
            steps {
                echo "Cloning Philippine Location API from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/philippine-location-api'
                echo "Cloning Philippine Location API from Github. Success!"
            }
        }
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker tag pla:latest elleined/pla:latest'
                sh 'docker push elleined/pla:latest'
